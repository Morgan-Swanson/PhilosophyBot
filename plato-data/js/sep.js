...
$(document).ready(function() {
	...
	// CODE FOR sep.js at AUSTRALIA mirror site	
	$('#mirrors .btn-group').replaceWith(
'        <div class="btn-group">\n' +
'<a class="btn dropdown-toggle" data-toggle="dropdown" href="https://stanford.library.sydney.edu.au"><span class="flag flag-australia"></span> Australia <span class="caret"></span><span class="mirror-source">Library, University of Sydney</span></a>' +
